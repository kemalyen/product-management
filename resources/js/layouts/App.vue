        ...
        <nav v-if="auth.isAuthenticated" class="bg-white shadow-sm border-b border-gray-200">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden sm:flex sm:space-x-8">
                            ...
                            <RouterLink v-if="auth.hasRole('Admin')" to="/accounts" class="inline-flex items-center px-1 pt-1 text-sm font-medium border-b-2" active-class="border-indigo-500 text-indigo-600" inactive-class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700">
                                Accounts
                            </RouterLink>
            ...
            <div class="sm:hidden" id="mobile-menu" v-show="mobileMenuOpen">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <RouterLink v-if="auth.hasRole('Admin')" to="/accounts" class="block pl-3 pr-4 py-2 text-base font-medium border-l-4" active-class="bg-indigo-50 border-indigo-500 text-indigo-700" inactive-class="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700">
                        Accounts
                    </RouterLink>
                </div>
            </div>
