        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button
                        v-if="auth.hasRole('Account Admin')"
                        @click="openModal()"
                ...
                <table v-else class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th v-if="auth.hasRole('Account Admin')" scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Actions
                            </th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="user in users" :key="user.id">
                            ...
                            <td v-if="auth.hasRole('Account Admin')" class="px-6 py-4 whitespace-nowrap text-sm font-medium">
